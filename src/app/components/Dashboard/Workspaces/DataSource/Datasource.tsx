  ...
  return (
      <div className='datasource'>
        ...
        <table className="min-w-max bg-white w-full h- table-auto rounded-md ">
          <thead>
            <tr className="border-b py-4 text-sm font-bold leading-normal">
              ...
              <th className="py-3 px-6 flex mx-3 text-center">Sync duration</th>
        ...
        <div className="flex h-[50vh] flex-col w-full  border mb-2">
          <div className="flex h-[8vh] border w-full bg-[#E6E6E6] px-2 items-center justify-between px-2">Connector Source
          <FaAngleDown /></div>
